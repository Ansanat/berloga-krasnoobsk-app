<template>
  ...
  >
    ...
    <div class="text-background">
      ...
      <div class="text" style="padding-top: 30px; font-weight: bold; text-indent: 0em;">
        Расписание коллективного парения:
      </div>
      <div class="text" style="padding-top: 10px; text-indent: 0em;">
